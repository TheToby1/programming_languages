...
val testchallenge_fail2 = typecheck_patterns ([], [TupleP [Variable("a"), ConstP(10), Wildcard], TupleP [Variable("a"), ConstP(10)]]) = NONE
val testchallenge_fail3 = typecheck_patterns ([("Red","color",UnitT),("Green","color",UnitT),("Blue","color",UnitT)], [ConstructorP("Red", ConstP(10)), Wildcard]) = NONE
